...
/**
 * @Author: 蔡晓杰
 * @Date: 2020/6/9 0009 8:54
 * @Version 1.0
 */
public class MyGeneratorNew {
    public static void main(String[] args) {
        ...
        sourceConfig.setUrl("jdbc:mysql://127.0.0.1:3306/szqy08_pro?characterEncoding=utf8");
        ...
        packageConfig.setParent("com.szqy08");// 自定义包路径
